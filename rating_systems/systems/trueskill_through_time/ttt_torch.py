...
class TrueSkillThroughTimeTorch(RatingSystem):
    """
    ...
    def update(self, batch: GameBatch) -> "TrueSkillThroughTimeTorch":
    ...
    def reset(self) -> "TrueSkillThroughTimeTorch":
